        ...
        >
            ...
            <div className=' relative z-10 min-h-screen md:w-3/5 lg:w-2/5 md:bg-[#161616] flex flex-col justify-center items-center w-[500px] h-[600px]'>
                ...
                <form onSubmit={handleLogin} className="text-left flex justify-center flex-col items-center text-white ">
                    ...
                    <div className='w-[350px] md:w-[400px] '>
                        ...
                        <div className='flex flex-col space-y-5'>
                            <input required className='glass-morphism py-4 w-full pl-4 pr-16 text-left outline-none rounded-sm font-raleway text-sm' placeholder='Email' type="email" name="email" />
                            <div className='relative'>
                                <input required className='glass-morphism w-full py-4 pl-4 pr-16 text-left outline-none rounded-sm font-raleway text-sm' placeholder='Password' type={passText ? "password" : "text"} name="password" />
                                <span onClick={() => setPassText(!passText)} className='absolute right-5 top-4'> {passText ? <FaLock /> : <FaLockOpen />} </span>
                            </div>
                            <span className=''> <SignButton name='Login'  ></SignButton> </span>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <h1 className='capitalize text-sm text-left text-white'>already have an account ? <Link to='/signup' className='hover:text-blue-500 transition-all'>SignUp</Link> </h1>
                </div>
